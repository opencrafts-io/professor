...
urlpatterns = [
    ...
    path('enrollments/', views.StudentCourseEnrollmentView.as_view(), name='enrollment-create'),
    path('register/', views.CourseRegistrationView.as_view(), name='course-registration'),
